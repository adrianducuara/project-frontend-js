...
export function buildFormSignup() {
  ...
  formContainer.innerHTML = `
        ...
        <form id="signup-form" class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="text-sm py-5">
                <a href="/login.html" class="font-medium text-indigo-600 hover:text-indigo-500">Iniciar sesión</a>
            </div>
            </div>
