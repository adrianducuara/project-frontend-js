...
export function builHeaderAction() {
    const headerContainer = buildElementHTMLAttr('header', 'class', 'bg-white');
    headerContainer.innerHTML = `
    <nav id="header-desktop" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="flex lg:hidden">
        <button id="open-button" type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
      ...
      <div id="link-account-desktop" class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="/login.html" class="-mx-3 mr-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Iniciar sesión</a>
        <a href="/signup.html" class="-mx-3 block rounded-lg py-2.5 px-3 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Registrarme</a>
      </div>
    </nav>
    <!-- Mobile menu, show/hide based on menu open state. -->
    <div class="lg:hidden" role="dialog" aria-modal="true">
      <!-- Background backdrop, show/hide based on slide-over state. -->
      <div id="header-mobile" class="fixed hidden inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
